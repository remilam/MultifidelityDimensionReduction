...
if __name__ == "__main__":
	...
	file = "synthetic_rank_deficient_SF"
	...
	for i, intdim in enumerate(int_vect[::2]):
		print i
		plt.semilogy(sample_vect, mean_error[:,i], '-'+symb[i], ms=10, color = mycolor[i], label='$\delta_{H}= {intdim}$'.format(H='H', intdim=intdim), linewidth=2)
